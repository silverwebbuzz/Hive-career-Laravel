...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-pills flex-column flex-sm-row mb-4">
            ...
            <li class="nav-item"><a class="nav-link active" href="{{route('editProfile')}}"><i class="fa-solid fa-pencil me-1"></i> Edit Profile</a></li>
        </ul>
    </div>
</div>
<!--/ Navbar pills -->
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <ul class="list-unstyled mb-4 mt-3">
                    <li class="d-flex align-items-center mb-3"><i class="ti ti-user text-heading"></i><span class="fw-medium mx-2 text-heading">Company Name:</span> <span>John Doe</span></li>
                    <li class="d-flex align-items-center mb-3"><i class="ti ti-check text-heading"></i><span class="fw-medium mx-2 text-heading">Post-Status:</span> <span>Active</span></li>
                ...
                <ul class="list-unstyled mb-4 mt-3">
                    <li class="d-flex align-items-center mb-3"><i class="ti ti-phone-call"></i><span class="fw-medium mx-2 text-heading">Phone:</span> <span>(123) 456-7890</span></li>
                    <li class="d-flex align-items-center mb-3"><i class="fa-solid fa-mobile-retro fa-xl"></i><span class="fw-medium mx-2 text-heading"> Mobile:</span><span>+918521479630</span></li>
                ...
                <ul class="list-unstyled mb-4 mt-3">
                    <li class="d-flex align-items-center mb-3"><i class="ti ti-phone-call"></i><span class="fw-medium mx-2 text-heading">Address:</span> <span>Swb, Science-city Road,Sola</span></li>
                    <li class="d-flex align-items-center mb-3"><i class="ti ti-phone-call"></i><span class="fw-medium mx-2 text-heading">City:</span> <span>Ahmedabad</span></li>
                    <li class="d-flex align-items-center mb-3"><i class="ti ti-mail"></i><span class="fw-medium mx-2 text-heading">State:</span> <span>Gujarat</span></li>
                    <li class="d-flex align-items-center mb-3"><i class="ti ti-flag text-heading"></i><span class="fw-medium mx-2 text-heading">Country:</span> <span>India</span></li>
                </ul>
    ...
    <div class="col-xl-8 col-lg-7 col-md-7">
        ...
        <div class="card card-action mb-4">
            <div class="card-header align-items-center">
                <h5 class="card-action-title mb-0">Company Information</h5>
                ...
                <ul class="timeline ms-1 mb-0">
                    ...
                    <li class="timeline-item timeline-item-transparent">
                        ...
                        <div class="timeline-event">
                            ...
                            <p class="mb-0">22AAAAA0000A1Z5</p>
                        </div>
                    </li>
                    <li class="timeline-item timeline-item-transparent">
                    ...
                    <li class="timeline-item timeline-item-transparent border-transparent">
                        ...
                        <div class="timeline-event">
                            ...
                            <p class="mb-0">25xxxxxxxxxx352</p>
                        </div>
                    </li>
                </ul>
            </div>
