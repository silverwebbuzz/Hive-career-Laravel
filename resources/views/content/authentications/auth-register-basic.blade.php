                            ...
                            <div id="Company-basic-details" class="content">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 d-flex justify-content-between">
                                        ...
                                        <a href="#Company-info" class="btn btn-primary btn-next"><span
                            ...
                            <div id="Company-info" class="content">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="file" id="identityproof" name="identityproof"
                                            class="form-control" placeholder=" Company Identity Proof" />
                                    </div>
                                    {{-- <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-12 d-flex justify-content-between">
                                        ...
                                        <a href="#Company-basic-details" class="btn btn-label-secondary btn-prev"><span
                                                class="align-middle d-sm-inline-block d-none me-sm-1">Previous</span> <i
                                                class="ti ti-arrow-left me-sm-1"></i></a>
                                        {{-- <button class="btn btn-primary btn-next"> <span class="align-middle d-sm-inline-block d-none me-sm-1">Next</span> <i class="ti ti-arrow-right"></i></button> --}}
