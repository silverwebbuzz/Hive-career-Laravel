...
//emailVarify
// Route::get('account/verify/{token}', [CompanyController::class, 'verifyAccount'])->name('user.verify');
...
Route::post('reset-password',  $controller_path . '\authentications\ResetPasswordBasic@submitResetPasswordForm')->name('reset.password.post');
...
Route::post('forget-password', $controller_path . '\authentications\ForgotPasswordBasic@submitForgetPasswordForm')->name('forget.password.post'); 
